...
const RegisterForm = () => {
  ...
  const[poblacion, setPôblacion] = useState('');
    ...
    <div className="container mt-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <select className="form-select" name="poblacio" value={poblacion} onChange={(e) => setPôblacion(e.target.value)} required>
        ...
        <div className="mb-3">
          ...
          <input className="form-control" name="codiPostal" value={zip}/>
        </div>
